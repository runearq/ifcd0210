Delta = function() {
  ...
  var cfg = {
    ...
    images: [
      ...
      { id: "rocks",   url: "images/rocas.png"   },
      { id: "bullets", url: "images/balas.png" }
    ],

    sounds: [
      { id: "title",   name: "sonidos/titulo",   formats: ['mp3', 'ogg'], volume: 0.4,  loop: true },
      { id: "game",    name: "sonidos/game",    formats: ['mp3', 'ogg'], volume: 0.8,  loop: true },
      { id: "shoot",   name: "sonidos/disparo",   formats: ['mp3', 'ogg'], volume: 0.04, pool: 5 },
      { id: "explode", name: "sonidos/explosion", formats: ['mp3', 'ogg'], volume: 0.10, pool: 5 }
    ],
